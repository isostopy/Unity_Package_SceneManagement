...
/// <summary>
/// Herramienta del editor que permite cargar cualquier escena de la carpeta de Assets sin que haya que estar buscandolas en la ventana del proyecto. </summary>
public class EditorSceneLoader : EditorWindow
{
	...
	[MenuItem("Isostopy/Scene Loader", priority = 5000)]
	public static void Open()
	{
		var window = EditorWindow.GetWindow(typeof(EditorSceneLoader), false);
	...
	// -----------------------------------------------------------------
	#region Load Scenes - Static functions
